...
if (isset($_GET['durum_guncelle'], $_GET['id'])) {
    ...
    header('Location: veteriner-ihbarlar.php?basarili=1');
    exit;
}
...
<head>
    ...
    <title>Veteriner İhbarları | Gebze Belediyesi</title>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (count($ihbarlar) === 0): ?>
                        <tr><td colspan="9" class="text-center text-muted py-4">Henüz ihbar yok.</td></tr>
                    <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href="?sil=<?php echo $t['id']; ?>" class="btn btn-sm btn-outline-secondary"
                                   onclick="return confirm('Bu ihbarı silmek istediğinize emin misiniz?');">
