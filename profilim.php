 ...
 * admin/profilim.php
 * -------------------------------------------------------
 * Giriş yapmış yöneticinin kendi profilini düzenlediği kişisel sayfa:
 * profil fotoğrafı, avatar rengi, unvan, ad soyad, kullanıcı adı ve şifre.
 * Sol menüdeki profil kutusuna tıklanınca buraya gelinir.
 * -------------------------------------------------------
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($adSoyad === '' || $kullaniciAdi === '') {
        ...
        if ($kontrol->fetch()['toplam'] > 0) {
            ...
            islemKaydet($pdo, 'Profilini Güncelledi', $adSoyad);

            header('Location: profilim.php?basarili=1');
            exit;
        }
    }
...
<div class="card admin-kart p-4">
    <h4 class="fw-bold mb-4"><i class="bi bi-person-circle me-2"></i>Profilim</h4>

    <?php if (isset($_GET['basarili'])): ?>
        <div class="alert alert-success alert-dismissible fade show">
            <i class="bi bi-check-circle-fill me-2"></i>Profiliniz başarıyla güncellendi.
    ...
    <form method="POST" action="profilim.php" enctype="multipart/form-data">
        <div class="row g-4">
