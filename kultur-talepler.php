...
if (isset($_GET['durum_guncelle'], $_GET['id'])) {
    ...
    header('Location: kultur-talepler.php?basarili=1');
    exit;
}
...
<head>
    ...
    <title>Kültür ve Sosyal İşler Talepleri | Gebze Belediyesi</title>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (count($talepler) === 0): ?>
                        <tr><td colspan="8" class="text-center text-muted py-4">Henüz talep yok.</td></tr>
                    <?php endif; ?>
